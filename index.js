console.log('This is College Books Library');
class Library {
...
function libraryFormSubmit(e) {
    ...
    let type;
    let GK_and_Others = document.getElementById('GK_and_Others');
    let Historical = document.getElementById('Historical');
    let Science_and_Technology = document.getElementById('Science_and_Technology');

    if (GK_and_Others.checked) {
        type = GK_and_Others.value;
    }
    else if (Historical.checked) {
        type = Historical.value;
    }
    else if (Science_and_Technology.checked) {
        type = Science_and_Technology.value;
    }
